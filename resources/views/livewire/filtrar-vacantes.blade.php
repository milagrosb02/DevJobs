    ...
    <div class="max-w-7xl mx-auto">
        ...
        >
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        {{-- asocio las variables de vacantes --}}
                        wire:model='termino'
                    />
                </div>
            ...
            <div class="flex justify-end">
                <input 
                    type="submit"
                    class="bg-purple-500 hover:bg-purple-600 transition-colors text-white text-sm font-bold px-10 py-2 rounded cursor-pointer uppercase w-full md:w-auto"
                    value="Buscar"
                />
            </div>
        </form>
